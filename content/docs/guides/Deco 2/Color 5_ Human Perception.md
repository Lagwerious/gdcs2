...
**Successive contrast** occurs when __looking at one color influences how you view the following colors__. This happens due to a process called adaptation, where the eyes adjust to take in more information with rods and cones.
...
**Impossible colors** are __a set of colors that cannot be seen normally__. Some of these colors cannot be recreated realistically and some of them can be produced.

The first set of impossible colors are the **imaginary colors**. __These colors are perceived by a combination of cone cells that cannot be achieved under normal circumstances.__
