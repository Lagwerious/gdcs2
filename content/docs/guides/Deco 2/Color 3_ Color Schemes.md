...
The most important things in your decoration should stand out the most, while less important things should have lower contrast.
...
A **color scheme** is a __collection of colors used to organize hue contrast in neat, easy-to-use ways.__
## Monochromatic

A **Monochromatic** color scheme is one where the __hues of the colors don't change.__ Hue and color are often interchanged but hue is fundamentally different in that it does not involve how dark or how dull something is. Thus, these color schemes involve different values and saturation.
...
**Analogous** color schemes involve __colors that are right next to each other on the color wheel__. An example of this is red, magenta, and purple.
...
**Tetradic** colors are a __set of 4 colors that form a rectangle and can also be thought of as 2 sets of complementary colors.__
...
**Gamut Maps** are useful tools that can help organize your colors and make them more harmonious.
They're represented by a color wheel which includes the different saturation levels of each color and a shape that is placed on top of the wheel. The objective you want with gamut maps is to have a fairly digestible and easily understood shape.
## Kgamut
